				...
				<table class="table table-condensed">
					...
					<tbody>
									...
									@foreach(Session::get('coupon') as $key => $cou)
										@if($cou['coupon_condition']==1)
											...
											<p>
												...
												echo '<p><li> total decrease:'.number_format($total_coupon,0,',','.').'đ</li></p>';
												@endphp
											</p>
											<p><li> total decrease :{{number_format($total-$total_coupon,0,',','.')}}đ</li></p>
										@elseif($cou['coupon_condition']==2)
											...
											<p><li> total decrease :{{number_format($total_coupon,0,',','.')}}đ</li></p>
										@endif
									@endforeach
						...
						<tr>
							<td colspan="5"><center>
							@php 
							echo 'Please add products into your cart';
							@endphp
							</center></td>
						</tr>
						@endif
							...
							<form method="POST" action="{{url('/check-coupon')}}">
								@csrf
									<input type="text" class="form-control" name="coupon" placeholder="Input promotion code"><br>
	                          		<input type="submit" class="btn btn-default check_coupon" name="check_coupon" value="Including promotion code">
