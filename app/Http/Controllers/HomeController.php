...
class HomeController extends Controller
{
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "We sell all of the products which are related to games such as PlayStation, Gaming Desktop, Gaming Laptop, etc. Come here and get it."; 
        $meta_keywords = "Gaming items, PlayStation, Game Online, Laptop, Desktop";
        $meta_title = "Powerful gaming products for everyone";
